...
window.latencyTracker = {
  ...
  record: function(questionId, responseValue) {
    ...
    console.log('Latency Event - QuestionId:', questionId, 'Latency (ms):', latency, 'Response:', responseValue);
    
    Shiny.setInputValue('latency_event', {
      questionId: questionId,
      responseValue: responseValue,
      latency: parseInt(latency)  // Ensure it's an integer in milliseconds
    }, {priority: 'event'});
  }
};
...
function attachListeners() {
  document.querySelectorAll('input[type="radio"]').forEach(function(radio) {
    ...
    radio.onclick = function() {
      console.log('Radio button clicked for question:', questionId);
