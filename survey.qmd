...
Please notify the experimenter (across the room from you) that you are ready for the next portion of the experiment!
...
For this half of the survey, we want you to rate **how desirable** is it to be for someone to be, in our culture, across a number of different characteristics.
...
FILL IN EXAMPLES LIKE K&T HERE
...
sd_question(
  type  = 'matrix',
  id    = 'edprac1_EH',
  label = "How desirable is this characteristic?",
  row="",
  option = c(
    'Extremely Undesirable'    = '1',
    'Strongly Undesirable'     = '2',
    'Moderately Undesirable'   = '3',
    'Mildly Undesirable'       = '4',
    'Neutral'                  = '5',
    'Mildly Desirable'         = '6',
    'Moderately Desirable'     = '7',
    'Strongly Desirable'       = '8',
